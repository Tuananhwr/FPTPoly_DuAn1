...
public class NhanVienUI extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    public void fillToTable(List<NhanVien> list) {
        ...
        String cols[] = {"Mã NV", "Mật khẩu", "Họ tên", "Giới tính", "Địa chỉ", "SDT",
            "CCCD", "Ngày vào làm", "Ngày nghỉ", "Ngày tạo", "Ngày sửa", "Trạng thái"};
        ...
        for (NhanVien nv : list) {
            ...
            tblModel.addRow(new Object[]{nv.getMaNV(), nv.getMatKhau(), nv.getHoTen(),
                gt, nv.getDiaChi(), nv.getSDT(), nv.getCCCD(), nv.getNgayVaoLam(), nv.getNgayNghi(),
    ...
    public void fillToTable22(List<NhanVien> list) {
        DefaultTableModel tblModel = new DefaultTableModel();
        String cols[] = {"Mã NV", "Mật khẩu", "Họ tên", "Giới tính", "Địa chỉ", "SDT",
            "CCCD", "Ngày vào làm", "Ngày nghỉ", "Ngày tạo", "Ngày sửa",
    ...
    private void initComponents() {
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/Price list.png"))); // NOI18N
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtCCCD, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE)
